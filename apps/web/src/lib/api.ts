...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  "Bet already settled": "Ce pari est déjà réglé (résolu ou retiré).",
  "Not allowed to withdraw this bet": "Vous n'avez pas le droit de retirer ce pari.",
  "Not your bet": "Ce pari ne vous appartient pas.",
  "Bet already withdrawn": "Ce pari a déjà été retiré.",
